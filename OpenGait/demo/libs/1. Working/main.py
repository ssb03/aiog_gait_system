...
def main():
    ...
    gallery_video_paths = [
        "./demo/output/InputVideos/Set/1.mp4",
        # "./demo/output/InputVideos/Set/gallery2.mp4",
        # "./demo/output/InputVideos/Set/gallery3.mp4",
        "./demo/output/InputVideos/Set/11.mp4",
        # "./demo/output/InputVideos/Set/gallery12.mp4",
        # "./demo/output/InputVideos/Set/gallery13.mp4",
        # Add more gallery video paths here
    ]

    probe_video_paths = [
        "./demo/output/InputVideos/Set/12.mp4",
        # "./demo/output/InputVideos/Set/probe12.mp4",
        # "./demo/output/InputVideos/Set/probe3.mp4",
        # "./demo/output/InputVideos/Set/probe4.mp4",
    ...
    for gallery_video_path in gallery_video_paths:
        ...
        features = extract_sil(gallery_silhouettes[gallery_video_path], feature_folder)
    ...
    for probe_video_path in probe_video_paths:
        ...
        os.makedirs(feature_folder, exist_ok=True)
        probe_features = extract_sil(probe_silhouette, feature_folder)
